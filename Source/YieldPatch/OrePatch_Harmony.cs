...
namespace YieldPatch
{
    ...
    class OrePatch_Harmony
    {
        ...
        public static class BuildingProperties_EffectiveMineableYield
        {
            ...
            {
                var thingParent = (from ThingDef thingDef in DefDatabase<ThingDef>.AllDefsListForReading where thingDef.building != null && thingDef.building.mineableThing == __instance.mineableThing select thingDef).FirstOrDefault();
        ...
        {
            static void Postfix(ref float __result, ThingDef __instance)
            {
